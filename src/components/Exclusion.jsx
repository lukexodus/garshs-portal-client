...
const Exclusion = ({ exclusion, refetch, ...props }) => {
    ...
    <div className="flex flex-col space-y-2  text-gray-900">
      ...
      <div className="relative group">
        ...
        (data.user.role === "admin" || data.user.role === "superadmin") ? (
          <span
            className={`bg-red-100 absolute invisible group-hover:visible top-[0.1rem] right-0 p-1 rounded-full`}
          >
            <MdDeleteForever
              ...
              onClick={() => {
                setPopupModal({
                  ...
                  primary: "Delete",
                  handler: () => {
                    deleteExclusionHandler(exclusion._id);
                  },
                });
              }}
            />
        ...
        <div className="flex flex-col space-y-0">
          <h3 className="my-0 max-w-[28rem]">
            {exclusion.title} ({startDateFormatted}
