...
const AddEvent = ({ onEventAdded, ...props }) => {
  ...
  const submitHandler = (event) => {
    ...
    axios
      .post("/api/v1/events", processedFormState, {
        headers: {
      ...
      .then((res) => {
        if (res.data.success) {
          ...
          setCustomModal(null);
          onEventAdded(processedFormStateConverted);
        } else {
  ...
  return (
    <>
      <h3 className="mb-4 text-xl font-medium text-gray-900 ">Add Event</h3>
